...
We added an hourstart column to the taxi dataset, by taking the hour value of pickup_datetime for each observation of taxi_data. We then checked that there were only 24 unique values representing the 24 hours. 
